...
package com.Meditation.Sounds.frequencies.utilbilling;
...
//            result = new IabResult(IABHELPER_USER_CANCELLED, "Profile canceled.");
//            if (mPurchaseListener != null && result != null)
//                mPurchaseListener.onIabPurchaseFinished(result, null);
//        } else {
...
//        String[] iab_msgs = ("0:OK/1:Profile Canceled/2:Unknown/" +
...
//                Toast.makeText(mContext, "helper is not set up. Can't perform operation...", Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
//
